...
# df = pd.read_csv("veri seti dizinini yazıyoruz")
...
# df.drop(delete_indexes, axis=0, inplace=True) kalıcı işlem yapmak için inplace
...
# Categorical variant: column chart. countplot bar
...
# TYPE CHANGE IF TYPE IS BOOL WE CAN CONVERT THE TYPE INTO TO VISUALIZE.
